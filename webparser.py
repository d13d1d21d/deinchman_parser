...
class Parser:
    ...
    @debug("Ошибка в парсинге брендов", True)
    ...
    @debug("Ошибка в получении количества товаров для {brand}", True)
    ...
    @debug("Ошибка в получении списка товаров для {brand}", True)
    ...
    @debug("Ошибка в парсинге товара {product}")
